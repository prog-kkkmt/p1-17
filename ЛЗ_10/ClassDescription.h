...
struct event{
	string ImportanceSobutions; ///Êîä ñîáûòèÿ
	string name;///íàçâàíèå ñîáûòèÿ
    string ImportanceSobutionsVersions;///Êîä âèäà ñîáûòèÿ
...
void settings(event &mas){///èçìåíåíèå
	...
	switch(k){
		case 1:cout<<"Ââåäèòå íîâîå èìÿ "; cin>>mas.name; break;
		...
		case 4:cout<<"Ââåäèòå íîâé êîä ñîáûòèÿ "; cin>>mas.ImportanceSobutions; break;
		case 5:cout<<"Ââåäèòå íîâûé êîä âèäà ñîáûòèÿ "; cin>>mas.ImportanceSobutionsVersions; break;
		case 6:
			char c;
			do{
				cout<<"áûëî ëè âûïîëíåíî ñîáûòèå: ";
