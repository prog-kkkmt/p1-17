...
//Меню программы
void Menu() {
	Initialization();//Считывание из файлов 
	int key;
	bool exit = true;
	...
	while (exit)
	{
		...
		printDefaultMenu();//Печать основного меню
		switch ((key = _getch()))
		{
...
void About(bool* exit) {
	...
	while (key != '0') {
		...
		cout << "|                                        |" << endl;
		cout << "|                                        |" << endl;
		cout << "|     Версия 1.3.21                      |" << endl;
		cout << "|     Автор               Величко В.А.   |" << endl;
		cout << "|________________________________________|" << endl;
		cout << "|                                        |" << endl;
		cout << "|   0: Назад                             |" << endl;
		cout << "| Esc: Выход                             |" << endl;
...
void printRoom() {
	...
	while (key != '0') {
		...
		cout << "|___________________________________________________|" << endl;
		cout << "|  Код   |   Код     |  Номер   | Всего  |   Цена   |" << endl;
		cout << "| номера | категории |          |  мест  |   день   |" << endl;
		cout << "|___________________________________________________|" << endl;
		cout << "|                                                   |" << endl;
		for (int i = 0; i != rooms.size(); i++) {
...
void printCategory() {
	...
	while (key != '0') {
		...
		cout << "|_____________________________________________|" << endl;
		cout << "|   Код     |    Название    |      Цена      |" << endl;
		cout << "| категории |   категории    |   категории    |" << endl;
		cout << "|_____________________________________________|" << endl;
		cout << "|                                             |" << endl;
		for (int i = 0; i != categories.size(); i++)
		...
		if (key == 'e') {
			...
			for (int i = 0; i != categories.size(); i++) {
				if (categories[i].categoryiD == searchiD) {
					...
					int newprice;
					cout << "|____________________________|" << endl;
					cout << "|      Введите новую         |" << endl;
					cout << "|       цену за день  :      |" << endl;
					cout << "|____________________________|" << endl;
					cin >> newprice;
