...
def inst():
    ...
    def clicked():
        ...
        f = open('inst.txt', 'a', encoding = 'utf-8')
    ...
    lbl1 = Label(window)
    lbl2 = Label(window)
    lbl1.configure(font = 'Batang 20', text = '    Имя', bg = 'pink', fg = 'crimson')
    ...
    btn = Button(window, text = "Добавить", font = 'Batang 20', command=clicked, bg = 'hotpink')  
    ...
    btn1 = Button(window, text = "Удалить", font = 'Batang 20', command=clicked1, bg = 'hotpink')  
