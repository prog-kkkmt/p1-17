...
root.geometry("1280x690")## размеры окна
root.title("Туристский Клуб")## заголовок окна
root.resizable(False, False)
c = Canvas(root, width = 1280, height = 730, bg = 'black')## адресовка графических примитивов (родительское окно, ширина, высота и цвет фона)
c.pack()
