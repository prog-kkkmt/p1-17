...
def sklad():
    ...
    lbl1 = Label(window)
    lbl2 = Label(window)
    lbl1.configure(font = 'Batang 20', text = 'Название\nтовара', bg = 'lightskyblue')
    lbl1.place(x = 45, y = 51)
    lbl2.configure(font = 'Batang 20', text = 'Кол-во', bg = 'lightskyblue')
    ...
    lbl3.place(x = 45, y = 251)
    lbl4.configure(font = 'Batang 20', text = 'Кол-во', bg = 'lightskyblue')
