...
def sotrudniki():
    ...
    lbl1 = Label(window)
    lbl2 = Label(window)
    lbl1.configure(font = 'Batang 20', text = 'Сотрудник', bg = 'lightskyblue')
    lbl1.place(x = 25, y = 81)
    lbl2.configure(font = 'Batang 20', text = 'Должность', bg = 'lightskyblue')
    ...
    lbl3 = Label(window)
    lbl4 = Label(window)
    lbl3.configure(font = 'Batang 20', text = 'Сотрудник', bg = 'lightskyblue')
    lbl3.place(x = 25, y = 281)
    lbl4.configure(font = 'Batang 20', text = 'Должность', bg = 'lightskyblue')
