...
class Table1:
    ...
    def PrintOut1():
        df1 = pd.read_excel('Hostel.xlsx')
        print(df1[['Route Code', 'Route Name', 'Route Time', 'Route Category']])
#класс для работы с таблицей “Граждане ”
class Table2:
    def __init__(self, event_type_code, type_name):
        self.event_type_code = event_type_code
        self.type_name = type_name
    ...
    def PrintOut2():
        df2 = pd.read_excel('Hostel.xlsx')
        print(df2[["Leader's Code", 'NSL', 'Phone Number']])

#класс для работы с таблицей “Номера”
class Table3:
