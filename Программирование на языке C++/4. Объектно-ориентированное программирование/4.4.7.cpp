///Задание: (Задание повышенной сложности) Предполагаемое решение этого задания не переносимо с точки зрения стандарта, 
...
///Глава 4, раздел 4, шаг 7. https://stepik.org/lesson/555/step/7
